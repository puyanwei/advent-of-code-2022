...
export const programOne = `noop
addx 3
addx -5`

export const programTwo = `addx 15
addx -11
noop
addx 6`

export const programThree = `addx 15
addx -11
addx 6
addx -3
addx 5
...
export const duplicateCycleData = [
  { cycle: 1, command: "addx 15", x: 1 },
  { cycle: 2, command: "[pending]", x: 1 },
  { cycle: 2, command: "addx -11", x: 16 },
  { cycle: 4, command: "[pending]", x: 16 },
]
